"""
Django settings for django_cache_project project.
...
SECRET_KEY = '5@*$x7y!91qj+q$8)o4y4ezs#6mcqv+adl+uxq6t@$6y*yj85!'
...
WSGI_APPLICATION = 'django_cache_project.wsgi.application'
